...
Install, `template-info.yaml`, `dev-template configure`, PostgreSQL wiring, port forwards, architecture, deployment, and CI/CD are documented here:

**[https://tmp.sovereignsky.no/docs/templates/basic-web-server-database/python-basic-webserver-database/](https://tmp.sovereignsky.no/docs/templates/basic-web-server-database/python-basic-webserver-database/)**

The sections below cover only the **Flask app** (`app/app.py`), **schema** (`config/init-database.sql`), and how they connect.
