...
<TemplateHeader
  ...
  version="1.0.0"
  description="Deploys PostgreSQL and creates a sample database with seed data"
  abstract={"A minimal UIS template that deploys PostgreSQL and creates a sample tasks table with seed data. Shows the full uis template flow from registry to deployed, configured service. Use this to verify your UIS setup or as a starting point for your own stack templates."}
...
<summary>Files (4)</summary>

<pre className="filesTree">
├── <a href="https://github.com/helpers-no/dev-templates/blob/main/uis-stack-templates/postgresql-demo/.gitignore" target="_blank" rel="noopener noreferrer">.gitignore</a>
├── <a href="https://github.com/helpers-no/dev-templates/blob/main/uis-stack-templates/postgresql-demo/README-postgresql-demo.md" target="_blank" rel="noopener noreferrer">README-postgresql-demo.md</a>
├── <a href="https://github.com/helpers-no/dev-templates/blob/main/uis-stack-templates/postgresql-demo/template-info.yaml" target="_blank" rel="noopener noreferrer">template-info.yaml</a>
└── config/
    └── <a href="https://github.com/helpers-no/dev-templates/blob/main/uis-stack-templates/postgresql-demo/config/init-database.sql" target="_blank" rel="noopener noreferrer">init-database.sql</a>
</pre>
...
<a href="https://mermaid.live/edit#base64:" target="_blank" rel="noopener noreferrer" className="mermaidLiveLink">↗ Open in mermaid.live</a>
...
<a href="https://mermaid.live/edit#base64:" target="_blank" rel="noopener noreferrer" className="mermaidLiveLink">↗ Open in mermaid.live</a>
