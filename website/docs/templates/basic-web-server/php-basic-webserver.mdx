...
<TemplateEnvironment
  requires={null}
  params={null}
  quickstart={{"title":"Run the PHP server","commands":["php -S 0.0.0.0:3000 -t public"],"run":"php -S 0.0.0.0:3000 -t public","note":"PHP's built-in server runs on port 3000. VS Code auto-forwards the port.\n"}}
