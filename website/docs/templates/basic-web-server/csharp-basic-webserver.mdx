...
<TemplateEnvironment
  requires={null}
  params={null}
  quickstart={{"title":"Run the ASP.NET Core app","commands":["dotnet watch run"],"note":"ASP.NET Core runs on port 3000 with hot reload via dotnet watch. VS Code auto-forwards the port.\n"}}
