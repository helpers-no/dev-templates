...
|----------|------|---------|
| [Plan: Application catalogue entries (`install_type: application`)](PLAN-application-catalogue.md) | Support a third entry kind in `template-registry.json` — an **application**, whose install | 2026-09-09 |
