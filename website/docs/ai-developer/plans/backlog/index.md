...
| [Doc: Eir's Rescue-Comms App — A Walkthrough](DOC-eir-rescue-comms-walkthrough.md) | Ground the dev-templates value proposition in a concrete person solving a concrete problem. Follow Eir from the moment she sees a problem on a rescue mission through the moment her app is running on Red Cross infrastructure — and show the mechanism that makes that possible: templates that encode organisational standards so adoption becomes administrative, not technical. | 2026-04-16 |
